...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Acrogym is a UAE-based company specializing in comprehensive software solutions, including frontend, backend, DevOps, infrastructure, and mobile services. We bring innovation and excellence to your digital projects."}],"link":[{"rel":"icon","type":"image/png","href":"/favicon.png"},{"rel":"canonical","href":"https://www.akrogym.org"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;500;600;700;800&display=swap"}],"style":[],"script":[],"noscript":[],"title":"Acrogym"};
